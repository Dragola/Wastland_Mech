...
public class player : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //scripts
        scriptE = GameObject.Find("world0").GetComponent<world>();
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) & buildM == false)
        {
            ...
            Physics.Raycast(ray, out hit, 4);
            {
                ...
                {
                    hit.collider.GetComponent<zombie>().health -= 5;
                }
            }
        }
        //------------------------------------------Movement-----------------------------------------------------
    ...
    void Build()
    {
        ...
        if (spawnB == false && building != 0)
        {
            ...
            switch (building)
            {
                //base
                case 1:
                    tempB = Instantiate(scriptE.buildings[0], buildPlace, Quaternion.Euler(0, 0, 0));
                    spawnB = true;
                    break;
                //wall
                case 2:
                    tempB = Instantiate(scriptE.buildings[1], buildPlace, Quaternion.Euler(0, 0, 0));
                    spawnB = true;
                    break;
                //solar panel
                case 3:
                    tempB = Instantiate(scriptE.buildings[2], buildPlace, Quaternion.Euler(0, 0, 0));
                    spawnB = true;
                    break;
                //generator
                case 4:
                    tempB = Instantiate(scriptE.buildings[3], buildPlace, Quaternion.Euler(0, 0, 0));
                    spawnB = true;
                    break;
                //wire
                case 5:
                    tempB = Instantiate(scriptE.buildings[4], buildPlace, Quaternion.Euler(0, 0, 0));
                    spawnB = true;
                    break;
            }
        }
        if (spawnB == true)
        {
            ...
            if (Input.GetMouseButtonDown(0) && spawnB == true)
            {
                tempB = null;
                spawnB = false;
                scriptE.new_power_building = true;
            }
            //rotate left
